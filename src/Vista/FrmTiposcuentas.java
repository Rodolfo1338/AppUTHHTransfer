 ...
 * @author Rodol
 */
public class FrmTiposcuentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txttipocuenta.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
        ...
        lbltitulo.setText("Tipos de Cuentas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTiposcuentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTiposcuentas().setVisible(true);
            }
        });
    }
